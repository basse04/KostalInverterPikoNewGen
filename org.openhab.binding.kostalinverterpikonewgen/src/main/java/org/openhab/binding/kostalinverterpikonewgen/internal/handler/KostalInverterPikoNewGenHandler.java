...
import org.openhab.binding.kostalinverterpikonewgen.internal.ChannelConfig;
import org.openhab.binding.kostalinverterpikonewgen.internal.DxsEntries;
import org.openhab.binding.kostalinverterpikonewgen.internal.DxsEntriesCfg;
import org.openhab.binding.kostalinverterpikonewgen.internal.DxsEntriesCfgExt;
import org.openhab.binding.kostalinverterpikonewgen.internal.DxsEntriesCfgExtExt;
import org.openhab.binding.kostalinverterpikonewgen.internal.DxsEntriesContainer;
import org.openhab.binding.kostalinverterpikonewgen.internal.KostalInverterPikoNewGenBindingConstants;
import org.openhab.binding.kostalinverterpikonewgen.internal.KostalInverterPikoNewGenConfiguration;
import org.openhab.binding.kostalinverterpikonewgen.internal.configuration.KostalConfigurationHandler;
...
/**
 * The {@link KostalInverterPikoNewGenConfHandler} is responsible for handling commands, which are
 ...
 */
// @NonNullByDefault
public class KostalInverterPikoNewGenHandler extends BaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(KostalInverterPikoNewGenHandler.class);

    // @Nullable
    private KostalInverterPikoNewGenConfiguration config;

    @SuppressWarnings("unused")
    // @Nullable
    private KostalInverterPikoNewGenBindingConstants configurationConfig;
    ...
    public KostalInverterPikoNewGenHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        config = getConfigAs(KostalInverterPikoNewGenConfiguration.class);
        ...
        }, 0, KostalInverterPikoNewGenConfiguration.REFRESHINTERVAL, TimeUnit.SECONDS);
